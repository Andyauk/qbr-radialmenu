...
RegisterNetEvent('qbr-radialmenu:ResetClothing', ResetClothing)
...
RegisterNetEvent('qbr-radialmenu:ToggleClothing', ToggleClothing)
...
RegisterNetEvent('qbr-radialmenu:ToggleProps', ToggleProps)
